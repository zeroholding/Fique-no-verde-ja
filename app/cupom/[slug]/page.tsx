...
export default function CupomSlugPage() {
  ...
  useEffect(() => {
    const fetchCouponData = async () => {
      try {
        ...
        // Reutiliza a mesma API publica, que agora aceita slug ou ID
        const res = await fetch(`/api/parceiros/cupons/${slug}?${params.toString()}`);
    ...
    <div className="min-h-screen bg-[#0a0a0a] text-gray-100 flex flex-col font-sans selection:bg-emerald-500/30">
      ...
      <main className="flex-1 w-full max-w-6xl mx-auto p-4 sm:p-6 lg:p-8 relative z-10 pt-12 sm:pt-20">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 lg:gap-6 mb-12">
          ...
          <div className="bg-gradient-to-b from-emerald-900/40 to-emerald-900/10 rounded-3xl p-6 border border-emerald-500/20 relative overflow-hidden group hover:border-emerald-500/50 transition-colors shadow-2xl">
          ...
          <div className="bg-gradient-to-b from-indigo-900/40 to-indigo-900/10 rounded-3xl p-6 border border-indigo-500/20 relative overflow-hidden group hover:border-indigo-500/50 transition-colors shadow-2xl">
