...
export default function Home() {
  ...
  return (
    <>
      ...
      <header id="navbar" className={scrolled ? "scrolled" : ""}>
        <div className="container nav-container">
          <Link href="#" className="logo">
            <img
              src="/assets/logolinhafqnvj.png"
              alt="Fique no Verde Já"
            />
          </Link>
          <nav className="nav-menu">
            <ul>
              ...
              <li><Link href="/login" className="text-primary hover:text-green-400 transition-colors">Entrar</Link></li>
            </ul>
          </nav>
      ...
      {/* Mobile Menu Overlay */}
      <div className={`mobile-menu-overlay ${mobileMenuActive ? "active" : ""}`} onClick={closeMenu}>
        <div className="mobile-menu-content" onClick={(e) => e.stopPropagation()}>
          ...
          <ul className="mobile-nav-links">
            ...
            <li><a href="#resultados" onClick={(e) => handleSmoothScroll(e, "#resultados")}>Resultados</a></li>
            <li><a href="#faq" onClick={(e) => handleSmoothScroll(e, "#faq")}>FAQ</a></li>
            <li><Link href="/login" onClick={closeMenu}>Entrar</Link></li>
          </ul>
          <a href="#contato" className="btn btn-primary btn-full" onClick={(e) => handleSmoothScroll(e, "#contato")}>
            Quero ficar no verde
          </a>
        </div>
      </div>
        ...
        <div className="container hero-container">
          <div className="hero-content">
            ...
            <p className="hero-subtitle fade-in-up delay-2">
              Estratégia de venda, preço e escala. Deixa reputação, atrasos e
              reclamações indevidas com quem vive isso todos os dias —
              <strong>sempre dentro das regras do Mercado Livre.</strong>
            </p>
          ...
          <div className="hero-visual fade-in-up delay-4">
            {/* Abstract Representation of Success/Green Reputation */}
            <div className="reputation-card glass-card">
              ...
              <div className="rep-meter">
                ...
                <div className="meter-indicators">
                  ...
                  <span className="indicator green active">
          ...
          <div className="filters-grid">
            <div className="filters-text scroll-reveal">
              <h2 className="section-title">
                Volte pros filtros que
                <span className="text-gradient">realmente vendem</span>
              </h2>
              <p className="section-desc">
                Você sabe a importância disso. Quando a reputação sai do verde,
                seus anúncios perdem os destaques que mais convertem.
              </p>
              ...
              <div className="impact-list">
                ...
                <div className="impact-item">
                  ...
                  <div className="impact-content">
                    <h3>Chegará hoje</h3>
                    <p>
                      O filtro Flex desaparece e sua conversão cai drasticamente.
                    </p>
                  </div>
                </div>
              </div>
              ...
              <a href="#contato" className="btn btn-secondary" onClick={(e) => handleSmoothScroll(e, "#contato")}>
                Quero voltar pros destaques
              </a>
            </div>
                ...
                <div className="filter-mockup">
                  ...
                  <div className="mockup-row active">
                    ...
                    <div className="filter-label">
                      Chegará amanhã <span className="tag">Full</span>
                    </div>
                  </div>
                  <div className="mockup-row active">
                    <div className="checkbox checked"></div>
                    <div className="filter-label">
                      Chegará hoje <span className="tag">Flex</span>
                    </div>
                  </div>
      ...
      <section className="section-connection">
        <div className="container">
          <div className="connection-header scroll-reveal">
            ...
            <p>
              Você já sabe como o Mercado Livre funciona. Seu tempo vale dinheiro.
            </p>
          </div>
          ...
          <div className="connection-footer scroll-reveal">
            <p>
              Resolver impacto de reputação não é o melhor uso da sua energia.
            </p>
            <a href="#contato" className="btn btn-outline" onClick={(e) => handleSmoothScroll(e, "#contato")}>
              Deixar isso com especialistas
            </a>
          </div>
        </div>
      </section>
        ...
        <div className="container">
          <div className="outsourcing-content">
            <div className="outsourcing-text scroll-reveal">
              ...
              <h2>
                Delegar reputação também é
                <span className="text-primary">estratégia de venda</span>
              </h2>
              <p className="lead">
                Assim como você não terceiriza sua estratégia de vendas pra
                qualquer um, reputação também não é tentativa e erro.
              </p>

              <ul className="check-list">
                <li>
                  <i className="fas fa-check-circle"></i> Remoção de atrasos indevidos
                </li>
                <li>
                  <i className="fas fa-check-circle"></i> Atuação em reclamações injustas
                </li>
                <li>
                  <i className="fas fa-check-circle"></i> Correção de impactos que travam a conta
                </li>
                <li>
                  <i className="fas fa-check-circle"></i> Estratégia técnica e segura
                </li>
              </ul>

              <div className="quote-box">
                "Você vende melhor quando não precisa apagar incêndio."
              </div>

              <a href="#contato" className="btn btn-primary btn-glow" onClick={(e) => handleSmoothScroll(e, "#contato")}>
                Quero minha reputação no verde
              </a>
            </div>
            {/* Visual or empty column for layout balance */}
          ...
          <div className="method-header-side scroll-reveal">
            <h2>
              ...
              <span className="highlight-wrapper">
                direta,
                <img
                  src="/assets/destaque-circulo.webp"
                  className="highlight-img circle-img"
                  alt="Destaque"
                />
              </span>
              <br />
              ...
              <span className="highlight-wrapper">
                ruído
                <img
                  src="/assets/destaque-plim.webp"
                  className="highlight-img plim-img"
                  alt="Brilho"
                />
              </span>
            </h2>
        ...
        <div className="container">
          <div className="roi-wrapper glass-panel scroll-reveal">
            <div className="roi-content">
              ...
              <p>
                Reputação sem estar no verde custa venda todos os dias. Corrigir
                isso é um investimento pequeno perto do retorno de:
              </p>
            ...
            {/* Floating rounded CTA */}
            <a href="#contato" className="roi-floating-btn" onClick={(e) => handleSmoothScroll(e, "#contato")}>
              Voltar<br />pro<br />verde
            </a>
          </div>
        </div>
      </section>
        ...
        <div className="container">
          <div className="security-flex">
            ...
            <div className="security-text scroll-reveal delay-1">
              ...
              <p>
                A <strong>FIQUE NO VERDE JÁ</strong> atua de forma independente,
                sem vínculo oficial com o Mercado Livre.
              </p>
              <p>
                Todas as ações são realizadas exclusivamente dentro das regras,
                políticas e critérios da própria plataforma.
              </p>
              <ul className="security-checks">
                <li>
                  <i className="fas fa-shield-check"></i> Nada fora do permitido
                </li>
                <li>
                  <i className="fas fa-shield-check"></i> Nada que coloque sua conta em risco
                </li>
              </ul>
              <a href="#contato" className="btn btn-outline btn-sm" onClick={(e) => handleSmoothScroll(e, "#contato")}>
                Ficar no verde com segurança
              </a>
            </div>
          </div>
        </div>
      ...
      <section id="contato" className="section-final-cta">
        <div className="container cta-container">
          <div className="cta-content scroll-reveal">
            <h2>
              Enquanto você foca em vender mais, <br />a gente cuida da sua reputação.
            </h2>
            <p>
              Se o impacto não foi justo, ele não deveria estar ali. Deixa isso
              com quem conhece e resolve.
            </p>
            ...
            <form className="contact-form glass-form">
              ...
              <button type="submit" className="btn btn-primary btn-block btn-glow">
                Quero ficar no verde agora
              </button>
              <span className="form-note">
                <i className="fas fa-lock"></i> Seus dados estão seguros. Sem compromisso.
              </span>
            </form>
          </div>
        </div>
      ...
      <footer className="main-footer">
        <div className="container">
          ...
          <div className="footer-disclaimer">
            <p>
              <strong>Aviso legal:</strong> Atuação independente, sem vínculo
              oficial com o Mercado Livre. Todas as ações são realizadas
              exclusivamente dentro das regras da plataforma.
            </p>
      ...
      {/* Font Awesome via CDN (Better to use next/script or layout, but inline for quick parity) */}
      <link
        rel="stylesheet"
