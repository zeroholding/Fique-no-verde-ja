...
async function run() {
    ...
    try {
        ...
        console.log(`Fetching claim details for 5480165828...`);
        
        const response = await fetch(`https://api.mercadolibre.com/post-purchase/v1/claims/5480165828`, {
            headers: {
        ...
        console.log("Full Claim Detail Keys:", Object.keys(data));
