-- CriaÃ§Ã£o do banco de dados (execute no pgAdmin primeiro)
-- CREATE DATABASE fqnj_db;

-- Conecte ao banco fqnj_db e execute os comandos abaixo
...
-- Ãndices para a tabela de sessÃµes
...
-- Ãndices para a tabela de origens
...
-- Ãndices para a tabela de clientes
...
-- Inserir algumas origens padrÃ£o
